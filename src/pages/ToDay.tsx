    ...
    <div className="pt-16 p-4 max-w-2xl mx-auto">
      <div className="flex mb-4">
        <input
          ...
          className="flex-1 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-100"
          value={searchQuery}
          ...
          <button
            ...
            className={`p-2 rounded-md shadow-sm text-center ${
              ...
              dates[index].toISOString().split("T")[0]
                ? "border-4 border-[#F8DA34] shadow-md"
        ...
        return (
          <div key={slot} className="space-y-2 mb-4">
            ...
            {slotHabits.length > 0 ? (
              ...
              <div className="p-2 bg-gray-100 rounded-md text-gray-500 text-center">
                Nothing to do here~~~
              </div>
            )}
          </div>
      ...
      {selectedHabit && (
        ...
        >
          <div className="bg-white rounded-lg shadow-2xl w-[60vw] min-w-[calc(100%/4)] h-[50vh] flex flex-col">
            <div className="p-4 border-b border-gray-200 flex justify-between items-center">
              <h3 className="text-xl font-semibold">Write Journal</h3>
            ...
            <div className="p-4 flex-1 flex flex-col">
              ...
              <textarea
                ...
                className="w-full flex-1 p-3 bg-gray-200 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
              />
            </div>
